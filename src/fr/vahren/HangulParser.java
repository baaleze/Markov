...
public class HangulParser {
    ...
    public static List<String> disassemble(final char hangul) throws HangulParserException {
        final List<String> jasoList = new ArrayList<>();

        final String hangulStr = String.valueOf(hangul);

        if (hangulStr.matches(".*[가-힣]+.*")) {
            final int baseCode = hangulStr.charAt(0) - FIRST_HANGUL;
    ...
    public static List<String> disassemble(final String hangul) throws HangulParserException {
        final List<String> jasoList = new ArrayList<>();
    ...
    public static String assemble(final List<String> jasoList) throws HangulParserException {
        if (jasoList.size() > 0) {
            String result = "";
            int startIdx = 0;
    ...
    private static String assemble(final List<String> jasoList, final int startIdx, final int assembleSize)
        throws HangulParserException {
    ...
    private static int getNextAssembleSize(final List<String> jasoList, final int startIdx)
        throws HangulParserException {
